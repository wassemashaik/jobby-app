...
class JobItemDetails extends Component {
  ...
  getJobData = async () => {
    ...
    if (response.ok === true) {
      ...
      const updatedSimilarJobData = data.similar_jobs.map(eachSimalarJob =>
        this.getFormattedSimilarData(eachSimalarJob),
      )
    ...
    return (
      <div className="job-details-view-container">
        ...
        <ul className="similar-jobs-list">
          {SimilarJobsData.map(eachSimalarJob => (
            <SimilarJobItem
              jobDetails={eachSimalarJob}
              key={eachSimalarJob.id}
            />
          ))}
        </ul>
      </div>
